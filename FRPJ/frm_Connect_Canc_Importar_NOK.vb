...
Public Class frm_Connect_Canc_Importar_NOK

    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs) Handles btnSelect.Click
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            strSqlTable = cls.Exec_Command_Scalar("select ValorParametro from tsys_Parametro where NomeParametro='Connect_Canc_NOK_SqlTable'")
            strFMTPath = cls.Exec_Command_Scalar("select ValorParametro from tsys_Parametro where NomeParametro='Connect_Canc_NOK_FMT'")
    ...
    Private Function ExecBulkFmt(ByVal strSqlTable As String, ByVal strFileD As String, ByVal strFirstRow As String, ByVal strFieldTerminator As String, ByVal strFMTPath As String) As Integer
        ...
        Try
            ...
            cls.Exec_Command_NQ("EXEC FRPJ_SP_CONNECT_CANC_UPDATE_NOK")
