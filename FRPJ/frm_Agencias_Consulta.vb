...
Public Class frm_Agencias_Consulta
    Dim myDataSet As DataSet
    Private Sub frm_Canc_Pend_Robo_Vc_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
