...
Public Class frm_EndossoCC_OK_Nivel2
    Dim myDataSet As DataSet
    Private Sub frm_EndossoCC_OK_Nivel2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPF_SP_ENDOSSO_CC_OK_NIVEL2"
