...
Public Class frm_Connect_Canc_Enviados_RECTOR
    Dim myDataSet As DataSet
    Private Sub frm_Connect_Canc_Enviados_RECTOR_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPJ_SP_CONNECT_CANC_ENVIADOS"
