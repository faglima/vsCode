...
Public Class frm_Motivo_PF
    Dim myDataSet As DataSet
    Private Sub frm_Motivo_PF_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPF_SP_CANC_MOTIVOS"
        ...
        Try
            ...
            If TypeOf senderGrid.Columns(e.ColumnIndex) Is DataGridViewButtonColumn AndAlso
               e.RowIndex >= 0 Then
                ...
                frm_Motivo2_PF.Tag = DataGridView1.Item(1, e.RowIndex).Value
                frm_Motivo2_PF.ShowDialog()
    ...
    Private Sub btnXml_Click(sender As Object, e As EventArgs) Handles btnXml.Click
        Try
            ...
            strFile = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) & "\FR_SISTEMA\Motivos_Canc_PF.xml"

            dttObj = cls.Return_DataTable("EXEC FRPF_SP_OFF_MOTIVOS_CANC", 2)

            clsU.GeraXml_DataTable(dttObj, strFile)

            strFile = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) & "\FR_SISTEMA\Motivos2_Canc_PF.xml"

            dttObj = cls.Return_DataTable("EXEC FRPF_SP_CANC_MOTIVOS2_CBO", 2)

            clsU.GeraXml_DataTable(dttObj, strFile)

            strFile = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) & "\FR_SISTEMA\Motivos_Arg_PF.xml"

            dttObj = cls.Return_DataTable("EXEC FRPF_SP_OFF_MOTIVOS_ARG", 2)

            clsU.GeraXml_DataTable(dttObj, strFile)

            strFile = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) & "\FR_SISTEMA\Motivos_CC_PF.xml"

            dttObj = cls.Return_DataTable("EXEC FRPF_SP_OFF_MOTIVOS_CC", 2)
