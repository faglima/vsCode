...
Public Class frm_Canc_Pend_Robo_Rector
    Dim myDataSet As DataSet
    Private Sub frm_Canc_Pend_Robo_Rector_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPJ_SP_CANC_AGUARDA_ROBO_RECTOR"
