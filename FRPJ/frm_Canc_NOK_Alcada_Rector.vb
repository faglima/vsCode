...
Public Class frm_Canc_NOK_Alcada_Rector
    Dim myDataSet As DataSet
    Private Sub frm_Canc_NOK_Alcada_Rector_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub tsbtn_Select_Click(sender As Object, e As EventArgs) Handles tsbtn_Select.Click
        Try
            ...
            If Me.DataGridView1.RowCount > 0 Then
                ...
                lngRec = cls.Exec_Command_NQ("EXEC FRPJ_SP_CANC_UPDATE_NOK_TRUE_ALCADA_RECTOR")
    ...
    Private Sub tsbtn_Reproc_Click(sender As Object, e As EventArgs) Handles tsbtn_Reproc.Click
        Try
            ...
            lngRec = CLng(cls.Exec_Command_Scalar("EXEC FRPJ_SP_CHECK_REPROC_ALCADA_RECTOR"))

            If lngRec > 0 Then

                lngRec = 0
                lngRec = cls.Exec_Command_NQ("EXEC FRPJ_SP_CANC_UPDATE_NOK_REPROC_ALCADA_RECTOR")
    ...
    Private Sub fSalvar()
        Try
            ...
            strSql = "EXEC FRPJ_SP_CANC_NOK_ALCADA_RECTOR"
    ...
    Private Sub fLoadForm()
        Try
            ...
            strSqlCbo = "EXEC FRPJ_SP_CANC_CODIGOS_CBO 1"
