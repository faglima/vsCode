...
Public Class frm_Canc_OK_Nivel2
    Dim myDataSet As DataSet
    Dim strEps As String = "0"
    Private Sub frm_Canc_Efetivado_Nivel2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPJ_SP_CANC_OK_NIVEL2 @EPS=" & strEps
