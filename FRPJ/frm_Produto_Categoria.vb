...
Public Class frm_Produto_Categoria
    Dim myDataSet As DataSet
    Private Sub frm_Produto_Categoria_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPJ_SP_CATEGORIAS"
    ...
    Private Sub btnXml_Click(sender As Object, e As EventArgs) Handles btnXml.Click
        Try
            ...
            strFile = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) & "\FR_SISTEMA\CategPJ.xml"

            dttObj = cls.Return_DataTable("EXEC FRPJ_SP_RET_CATEGORIAS_CBO")
