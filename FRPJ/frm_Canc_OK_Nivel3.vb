...
Public Class frm_Canc_OK_Nivel3
    Dim myDataSet As DataSet
    Dim strEps As String = "0"
    Private Sub frm_Canc_OK_Nivel3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPJ_SP_CANC_OK_NIVEL3 @EPS=" & strEps
