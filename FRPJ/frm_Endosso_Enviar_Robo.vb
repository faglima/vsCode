...
Public Class frm_Endosso_Enviar_Robo
    Dim myDataSet As DataSet
    Private Sub frm_Endosso_Enviar_Robo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPF_SP_ENDOSSO_PENDENTE"
    ...
    Private Sub tsbtn_EnviarRobo_Click(sender As Object, e As EventArgs) Handles tsbtn_EnviarRobo.Click
        ...
        Try
            ...
            If Me.DataGridView1.RowCount > 0 Then
                ...
                lngReg = cls.Exec_Command_NQ("EXEC FRPF_SP_ENDOSSO_UPDATE_ENVIAR_ROBO @Login='" & Environment.UserName & "'", 2)

                If (lngReg) > 0 Then
                    MessageBox.Show("Ligações enviadas para endosso com sucesso, favor acionar o robô de endosso!", "Enviar para robô", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    frm_Endosso_Enviar_Robo_Load(sender, New EventArgs)
                Else
