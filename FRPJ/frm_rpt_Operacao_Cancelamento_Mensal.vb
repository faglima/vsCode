...
Public Class frm_rpt_Operacao_Cancelamento_Mensal
    ...
    Private Sub PopulaRelatorio()
        Try
            Dim rptDS As New ReportDataSource("DsCancelamento", GetDataSourceRelatorio)
    ...
    Private Function GetDataSourceRelatorio() As DataTable
        Try
            ...
            If Not dtDataIni = Nothing AndAlso Not dtDataFim = Nothing Then
                ...
                Return cls.Return_DataTable("EXEC FRPJ_SP_RPT_CANCELAMENTO_CORRETORA_MENSAL " & strFiltros)
            Else
