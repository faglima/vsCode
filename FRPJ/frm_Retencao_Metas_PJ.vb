...
Public Class frm_Retencao_Metas_PJ
    Dim myDataSet As DataSet
    Private Sub frm_Retencao_Metas_PJ_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPJ_SP_RETENCAO_METAS_PJ"
