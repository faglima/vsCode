...
Public Class frm_Retencao_PJ
    Private intGrupo As Integer = 0
    Dim campos As New List(Of ValidCampo)
    Dim utl As cls_Utilities

    Private Sub frm_Retencao_PJ_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Me.KeyPress
        Try
    ...
    Private Sub frm_Retencao_PJ_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Try
    ...
    Private Sub frm_Retencao_PJ_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub btnSalvar_Click(sender As Object, e As EventArgs) Handles btnSalvar.Click
        Try
            ...
            Dim strArgumentacao As String = "null"
    ...
    Private Sub txtNome_TextChanged(sender As Object, e As EventArgs) Handles txtNome.TextChanged, txtEmail.TextChanged
        Call DesativarRetencao(sender)
    End Sub
    ...
    Private Sub txtNome_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles txtNome.Validating, txtEmail.Validating
