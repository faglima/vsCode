...
Public Class frm_Cargos
    ...
    Private Sub btnXml_Click(sender As Object, e As EventArgs) Handles btnXml.Click
        Try
            ...
            strFile = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) & "\FR_SISTEMA\CargosPJ.xml"

            dttObj = cls.Return_DataTable("EXEC FRPJ_SP_RET_CARGOS_CBO")
