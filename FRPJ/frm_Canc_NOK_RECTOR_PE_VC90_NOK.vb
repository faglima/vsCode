...
Public Class frm_Canc_NOK_RECTOR_PE_VC90_NOK
    Dim myDataSet As DataSet
    Private Sub frm_Canc_NOK_RECTOR_PE_VC90_NOK_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPJ_SP_CANC_NOK_RECTOR_PE_VC90_NOK"
