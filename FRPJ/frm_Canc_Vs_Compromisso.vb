...
Public Class frm_Canc_Vs_Compromisso
    Dim myDataSet As DataSet
    Private Sub frm_Canc_Vs_Compromisso_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPJ_SP_RETENCAO_VS_COMPROMISSO"
