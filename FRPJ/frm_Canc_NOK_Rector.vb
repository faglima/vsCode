...
Public Class frm_Canc_NOK_Rector
    Dim myDataSet As DataSet
    Dim strParam
    Private Sub frm_Canc_NOK_Rector_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub tsbtn_Select_Click(sender As Object, e As EventArgs) Handles tsbtn_Select.Click
        Try
            ...
            If Me.DataGridView1.RowCount > 0 Then
                ...
                lngRec = cls.Exec_Command_NQ("EXEC FRPJ_SP_CANC_UPDATE_NOK_TRUE_RECTOR " & strParam)
    ...
    Private Sub tsbtn_Unselect_Click(sender As Object, e As EventArgs) Handles tsbtn_Unselect.Click
        Try
            ...
            If Me.DataGridView1.RowCount > 0 Then
                ...
                lngRec = cls.Exec_Command_NQ("EXEC FRPJ_SP_CANC_UPDATE_NOK_FALSE_RECTOR " & strParam)
    ...
    Private Sub tsbtn_Reproc_Click(sender As Object, e As EventArgs) Handles tsbtn_Reproc.Click
        Try
            ...
            lngRec = CLng(cls.Exec_Command_Scalar("EXEC FRPJ_SP_CHECK_ENVIAR_RECTOR " & strParam))

            If lngRec > 0 Then

                lngRec = 0
                lngRec = cls.Exec_Command_NQ("EXEC FRPJ_SP_CANC_UPDATE_NOK_REPROCESSAR_RECTOR " & strParam)
    ...
    Private Sub tsbtn_Nivel2_Click(sender As Object, e As EventArgs) Handles tsbtn_Nivel2.Click
        Try
            ...
            If lngRec > 0 Then
                ...
                lngRec = 0
                lngRec = cls.Exec_Command_NQ("EXEC FRPJ_SP_CANC_UPDATE_NOK_NIVEL2_RECTOR @Login='" & Environment.UserName & "', " & strParam)
    ...
    Private Sub fSalvar()
        Try
            ...
            strSql = "EXEC FRPJ_SP_CANC_NOK_RECTOR " & strParam
    ...
    Private Sub fLoadCboMotivo()
        Try
            ...
            dtr = cls.Return_DataReader("EXEC FRPJ_SP_CANC_NOK_RECTOR_MOTIVO_CBO")
            With dtr
