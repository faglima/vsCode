...
Public Class frm_Canc_VendaNRec_Nivel1_Ok
    Dim myDataSet As DataSet

    Private Sub frm_Canc_NEfetuado_Nivel1_Ok_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Public Sub fLoadForm()
        Try
            ...
            strSql = "EXEC FRPJ_SP_NIVEL1_VENDA_N_RECONHECIDA_OK"
