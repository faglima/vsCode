...
Public Class frm_Retencao_PF_SAC
    ...
    Private Sub frm_Retencao_PF_SAC_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Me.KeyPress
        Try
    ...
    Private Sub Panel81_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Panel81.Paint
        ...
        End Try
    End Sub
    'Private Sub Panel82_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs)
    '    Try
    ...
    '    End Try
    'End Sub
    'Private Sub Panel83_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs)
    '    Try
    ...
    '    End Try
    'End Sub
    'Private Sub Panel84_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs)
    '    Try
    ...
    '    End Try
    'End Sub
    Private Sub frm_Retencao_PF_SAC_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Try
    ...
    Private Sub frm_Retencao_PF_SAC_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
        ...
        Try
            ...
            If Not txtCPF.Text = Nothing Then
                ...
                Else
                    ...
                    strSql = "EXEC FRPF_SP_CLIENTE_SELECT " & txtCPF.Text
                    intSelect = cls.Exec_Command_Scalar(strSql, 2)
    ...
    'End Sub
    'Private Sub rbtnArgumentacao_CheckedChanged_1(sender As Object, e As EventArgs)
    '    Try
    '        Dim strSqlCbo As String
    '        Dim clsU As New cls_Utilities
    ...
    'Private Sub rbtnCCredito_CheckedChanged(sender As Object, e As EventArgs)
    '    Try
    '        Dim strSqlCbo As String
    '        Dim clsU As New cls_Utilities
    ...
    'Private Sub rbtnVenda_CheckedChanged(sender As Object, e As EventArgs)
    '    Try
    '        Dim strSqlCbo As String
    '        Dim clsU As New cls_Utilities
    ...
    'Private Sub rbtnOferta_CheckedChanged(sender As Object, e As EventArgs)
    '    Try
    '        Dim strSqlCbo As String
    '        Dim clsU As New cls_Utilities
    ...
    'Private Sub rbtnEndosso_CheckedChanged(sender As Object, e As EventArgs)
    '    Try
    '        Dim strSqlCbo As String
    '        Dim clsU As New cls_Utilities
    ...
    '                strSqlCbo = "EXEC FRPF_SP_GET_ENDOSSO_PLANO_CBO @CodProduto=" & intCodProdutoVC & ",@VlrBase=" & strPremio & ",@Idade=" & strIdade & ",@Categoria=" & strCategoria & ",@Segmento=0"
    '            Else
    '                strSqlCbo = "EXEC FRPF_SP_GET_ENDOSSO_PLANO_CBO @CodProduto=" & intCodProdutoVC & ",@VlrBase=" & strPremio & ",@Idade=0, @Categoria=" & strCategoria & ",@Segmento=0"
    '            End If
    ...
    Function fValidaAtendimento() As Boolean
        Try
            ...
            Else
                ...
                '        Return False
                '    Else
                '        For Each ctl As Control In Me.Panel8.Controls(strDesfecho).Controls
    ...
    'Private Sub cboPlanoVenda_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs)
    '    Try
    '        Dim cls As New cls_SqlConnect
    ...
    Private Sub txtDataNasc_MaskInputRejected(sender As Object, e As MaskInputRejectedEventArgs)
        Call DesativarRetencao(sender)
    End Sub

    Private Sub txtIdade_TextChanged(sender As Object, e As EventArgs)
        Call DesativarRetencao(sender)
    End Sub
    ...
    'Private Sub cboProdutoVenda_SelectedIndexChanged(sender As Object, e As EventArgs)
    '    Try
    '        cboTipoResVenda.DataSource = Nothing
    ...
    'Private Sub cboTipoResVenda_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs)
    '    Try
    '        Dim clsu As New cls_Utilities
    '        Dim strSqlCbo As String
    ...
    Private Sub cboOferta_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub txtQt_Parcela_TextChanged(sender As Object, e As EventArgs)
