...
Public Class frm_rpt_Geral
    ...
    Private Sub frm_rpt_Geral_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If intPerfil = 6 Then
                ...
                strSql = "EXEC FRPJ_SP_ATENDIMENTO_GERAL_OP @DataIni='" & strDataIni & "',@DataFim='" & strDataFim & "',@Operador=" & strLoginF
            ...
            Else
                ...
                strSql = "EXEC FRPJ_SP_ATENDIMENTO_GERAL @DataIni='" & strDataIni & "',@DataFim='" & strDataFim & "',@Operador=" & strLoginF & ",@IDSup=" & strSup & ",@EPS=" & strEps
                cboEPS.Visible = True
            ...
            dtaTable = cls.Return_DataTable(strSql)
    ...
    Private Sub btnFiltrar_Click(sender As Object, e As EventArgs) Handles btnFiltrar.Click
        ...
        Try
            ...
            If intPerfil = 6 Then
                strSql = "EXEC FRPJ_SP_ATENDIMENTO_GERAL_OP @DataIni='" & strDataIni & "',@DataFim='" & strDataFim & "',@Operador=" & strLogin
            Else
                strSql = "EXEC FRPJ_SP_ATENDIMENTO_GERAL @DataIni='" & strDataIni & "',@DataFim='" & strDataFim & "',@Operador=" & strLogin & ",@IDSup=" & strSup & ",@EPS=" & strEps
            End If
    ...
    Private Sub btnLimpar_Click(sender As Object, e As EventArgs) Handles btnLimpar.Click
        ...
        Try
            ...
            Else
                ...
                strSql = "EXEC FRPJ_SP_ATENDIMENTO_GERAL @DataIni='" & strDataIni & "',@DataFim='" & strDataFim & "',@Operador=" & strLogin
            End If
