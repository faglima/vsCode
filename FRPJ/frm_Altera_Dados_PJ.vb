...
Public Class frm_Altera_Dados_PJ
    ...
    Private Sub frm_Altera_Dados_PF_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            DataGridView1.Columns("RazaoSocial").Width = 300
    ...
    Public Sub fLoadForm()
        Try
            ...
            strSql = "EXEC FRPJ_SP_ALTERA_DADOS_PJ @CodId=" & strCodId & ",@Cnpj=" & strCnpj
    ...
    Private Sub fSalvar()
        ...
        Try
            ...
            strSql = "EXEC FRPJ_SP_ALTERA_DADOS_PJ @CodId=" & strCodId & ",@Cpf=" & strCnpj
    ...
    Private Sub btnFiltrar_Click(sender As Object, e As EventArgs) Handles btnFiltrar.Click
        Try
            If Not txtProtocolo.Text = Nothing Or Not txtCnpj.Text = Nothing Then
