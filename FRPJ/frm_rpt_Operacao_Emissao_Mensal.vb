...
Public Class frm_rpt_Operacao_Emissao_Mensal

    Private Sub frm_rpt_Operacao_Corretora_Diario_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub PopulaRelatorio()
        Try
            ...
            Dim rptDS As New ReportDataSource("DsEmissao", GetDataSourceRelatorio)
    ...
    Private Function GetDataSourceRelatorio() As DataTable
        Try
            ...
            If Not dtDataIni = Nothing AndAlso Not dtDataFim = Nothing Then
                ...
                Return cls.Return_DataTable("EXEC FRPJ_SP_RPT_EMISSAO_MENSAL " & strFiltros)
            Else
