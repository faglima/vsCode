...
Public Class frm_Canc_NOK_Nivel32
    Dim myDataSet As DataSet
    Dim strEps As String = "0"
    Private Sub frm_Canc_NOK_Nivel32_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Dim btnOpen As New DataGridViewButtonColumn

            fLoadForm()

            If Not Me.Tag = "N3" Then
    ...
    Public Sub fLoadForm()
        ...
        Try
            ...
            strSql = "EXEC FRPJ_SP_NIVEL32_NOK @EPS=" & strEps
        ...
        Try
            ...
            If TypeOf senderGrid.Columns(e.ColumnIndex) Is DataGridViewButtonColumn AndAlso
               e.RowIndex >= 0 Then
                ...
                frm_Canc_NOK_Nivel32_Baixar.Tag = DataGridView1.Item(1, e.RowIndex).Value & ";" & DataGridView1.Item(2, e.RowIndex).Value
                frm_Canc_NOK_Nivel32_Baixar.Text = "Baixar Ligação Protocolo " & DataGridView1.Item(1, e.RowIndex).Value & " - Origem: " & DataGridView1.Item(2, e.RowIndex).Value
                frm_Canc_NOK_Nivel32_Baixar.ShowDialog()
