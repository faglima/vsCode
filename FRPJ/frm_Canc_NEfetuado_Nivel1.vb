...
Public Class frm_Canc_NEfetuado_Nivel1
    Dim myDataSet As DataSet

    Private Sub frm_Canc_NEfetuado_Nivel1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub btn_Salvar_Click(sender As Object, e As EventArgs) Handles btn_Salvar.Click
        Try
            ...
            strSql = "EXEC FRPJ_SP_NIVEL1_CANC_N_EFETUADO"
            MyDa = cls.Return_DataAdapter(strSql)

            MyDa.Update(myDataSet.Tables(0))
            Me.myDataSet.AcceptChanges()

            strSql = "EXEC FRPJ_SP_CANC_UPDATE_CANC_N_EFETUADO_NIVEL1 @Login='" & Environment.UserName & "'"
    ...
    Private Sub tsbtn_Excel_Click(sender As Object, e As EventArgs) Handles tsbtn_Excel.Click
        ...
        Try
            ...
            If Me.DataGridView1.RowCount > 0 Then
                'cls.GeraExcel_DataGrid(Me.DataGridView1, cls_Utilities.xlsOption.xlsOpen)
