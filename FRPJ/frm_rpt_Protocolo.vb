...
Public Class frm_rpt_Protocolo
    ...
    Private Sub btnFiltrar_Click(sender As Object, e As EventArgs) Handles btnFiltrar.Click
        ...
        Try
            ...
            If Not txtProtocolo.Text = Nothing Or Not txtCnpj.Text = Nothing Or Not txtApolice.Text = Nothing _
               Or Not txtCertificado.Text = Nothing Then
                ...
                If intPerfil = 6 Then
                    strSql = "EXEC FRPJ_SP_ATENDIMENTO_PROTOCOLO_OP @Protocolo=" & strProtocolo & ",@Cnpj=" & strCnpj & ",@Apolice=" & strApolice & ",@Certificado=" & strCertificado
                Else
                    strSql = "EXEC FRPJ_SP_ATENDIMENTO_PROTOCOLO @Protocolo=" & strProtocolo & ",@Cnpj=" & strCnpj & ",@Apolice=" & strApolice & ",@Certificado=" & strCertificado
                End If
