...
Public Class frm_Alcada_PF
    Dim myDataSet As DataSet
    Private intProdutoGrupo As Integer
    Private intLocalCanc As Integer

    Private Sub frm_Alcada_PF_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        Me.Close()
    End Sub
    ...
    Private Sub frm_Alcada_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPF_SP_ALCADA @CodId_Prod_Grupo=" & intProdutoGrupo
