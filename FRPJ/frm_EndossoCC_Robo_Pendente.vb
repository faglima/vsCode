...
Public Class frm_EndossoCC_Robo_Pendente
    Dim myDataSet As DataSet
    Private Sub frm_EndossoCC_Robo_Pendente_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPF_SP_ENDOSSO_CC_PENDENTE_ROBO"
