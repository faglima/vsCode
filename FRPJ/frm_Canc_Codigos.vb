...
Public Class frm_Canc_Codigos
    Dim myDataSet As DataSet
    Private Sub frm_Canc_Codigos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPJ_SP_CANC_CODIGOS"
            ...
            clsU.GetCboItems_DataGrid(strSqlCbo, cboLocal, "CodId_CLocal_Fk", "Local_Cancelamento")
