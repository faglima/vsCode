...
Public Class frm_rpt_Analitico_PJ
    ...
    Private Sub CarregaGrid(ByVal strDataIni As String, ByVal strDataFim As String)
        Try
            If Not (String.IsNullOrEmpty(strDataIni) And String.IsNullOrEmpty(strDataFim)) Then
                ...
                strSql = "EXEC FRPJ_SP_ATEND_RET_ANALITICO_PJ " & strDataIni & "," & strDataFim

                BindingSource1.DataSource = cls.Return_DataSet(strSql).Tables(0)
