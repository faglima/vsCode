...
Public Class frm_EndossoCC_NOK_Nivel2_Baixar

    Private Sub frm_EndossoCC_NOK_Nivel2_Baixar_KeyPress(sender As Object, e As KeyPressEventArgs) Handles MyBase.KeyPress
        Try
    ...
    Private Sub btnBaixar_Click(sender As Object, e As EventArgs) Handles btnBaixar.Click
        Try
            ...
            If MessageBox.Show("Tem certeza que deseja baixar a ligação de protocolo " & strProtocolo, "Atenção", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = Windows.Forms.DialogResult.Yes Then
                ...
                strSql = "EXEC FRPF_SP_ENDOSSO_CC_UPDATE_OK_NIVEL2 @CodId=" & strProtocolo & ", @Proposta=" & strProposta & ",@Login=" & strLogin & ",@Obs=" & strObs & ",@Emitido=" & strEmitido
                ...
                If intRet > 0 Then
                    ...
                    frm_EndossoCC_NOK_Nivel2.fLoadForm()
                    Me.Dispose()
                    Me.Close()
                Else
