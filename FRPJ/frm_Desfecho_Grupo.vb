...
Public Class frm_Desfecho_Grupo
    Dim myDataSet As DataSet
    Private Sub frm_Desfecho_Grupo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            DataGridView1.Columns.Insert(5, btnOpen2)
            ...
            If TypeOf senderGrid.Columns(e.ColumnIndex) Is DataGridViewButtonColumn AndAlso
               e.RowIndex >= 0 Then
                If e.ColumnIndex = 1 Then
                    ...
                    frm_Desfecho.Tag = DataGridView1.Item(2, e.RowIndex).Value & ";" & DataGridView1.Item(5, e.RowIndex).Value
                    frm_Desfecho.ShowDialog()
                ElseIf e.ColumnIndex = 0 Then
                    Me.Cursor = Cursors.WaitCursor

                    frm_Alcada.Tag = DataGridView1.Item(2, e.RowIndex).Value
                    frm_Alcada.ShowDialog()
