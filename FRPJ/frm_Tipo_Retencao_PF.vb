...
Public Class frm_Tipo_Retencao_PF
    Dim myDataSet As DataSet
    Private Sub frm_Tipo_Retencao_PF_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPF_SP_TIPO_RETENCAO"
