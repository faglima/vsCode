...
Public Class frm_Canc_NOK_Nivel2_Baixar
    ...
    Private Sub frm_Canc_NOK_Nivel2_Baixar_KeyPress(sender As Object, e As KeyPressEventArgs) Handles MyBase.KeyPress
        Try
    ...
    Private Sub btnBaixar_Click(sender As Object, e As EventArgs) Handles btnBaixar.Click
        Try
            ...
            intParentForm = CInt(ArrayItems(2))
            ...
            If MessageBox.Show("Tem certeza que deseja baixar a ligação de protocolo " & strProtocolo & vbCrLf _
                ...
                If intParentForm = 1 Then
                    strSql = "EXEC FRPJ_SP_UPDATE_CANC_OK_MANUAL @CodId=" & strProtocolo & ", @Login=" & strLogin & ",@VlrDev=" & strVlrDEv & ",@Obs=" & strObs
                Else
                    strSql = "EXEC FRPJ_SP_UPDATE_CANC_OK_NIVEL2 @CodId=" & strProtocolo & ", @Login=" & strLogin & ",@VlrDev=" & strVlrDEv & ",@Obs=" & strObs
                End If
            ...
            If intRet > 0 Then
                MessageBox.Show("ligação de protocolo " & strProtocolo & " baixada com sucesso!", "Confirmar", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    If intParentForm = 1 Then
                        strParam = ArrayItems(3).ToString
                        frm_Canc_NOK_VC.fLoadForm(strParam)
                    Else
                        frm_Canc_NOK_Nivel2.fLoadForm()
                    End If
    ...
    Private Sub frm_Canc_NOK_Nivel2_Baixar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
