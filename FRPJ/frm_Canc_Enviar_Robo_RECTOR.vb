...
Public Class frm_Canc_Enviar_Robo_RECTOR
    ...
    Private Sub frm_Canc_Enviar_Robo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPJ_SP_CANC_ENVIAR_ROBO @LocalCanc=" & Me.Tag
        ...
        Try
            ...
            If Me.DataGridView1.RowCount > 0 Then
                ...
                If (lngReg) > 0 Then
                    ...
                    frm_Canc_Enviar_Robo_Load(sender, New EventArgs)
                Else
    ...
    Private Sub txtLotes_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtLotes.KeyPress
