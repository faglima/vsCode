...
Public Class frm_Ferrari_Enviado
    Dim myDataSet As DataSet
    Private Sub frm_Ferrari_Enviado_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPF_SP_OFERTA_FERRARI_OK"
