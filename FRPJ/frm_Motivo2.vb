...
Public Class frm_Motivo2
    Dim myDataSet As DataSet
    Private intMotivo As Integer
    Private Sub frm_Motivo2_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        Me.Close()
    End Sub

    Private Sub frm_Motivo2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPJ_SP_CANC_MOTIVOS2 @CodId_Motivo=" & intMotivo
