...
Public Class frm_Produto_Segmento_PF
    Dim myDataSet As DataSet
    Private Sub frm_Produto_Segmento_PF_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub btnXml_Click(sender As Object, e As EventArgs) Handles btnXml.Click
        Try
            ...
            strFile = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) & "\FR_SISTEMA\SegPF.xml"

            dttObj = cls.Return_DataTable("EXEC FRPF_SP_RET_SEGMENTOS_CBO", 2)
