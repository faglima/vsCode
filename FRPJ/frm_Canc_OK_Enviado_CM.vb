...
Public Class frm_Canc_OK_Enviado_CM
    Dim myDataSet As DataSet

    Private Sub frm_Canc_OK_Enviado_CM_Leave(sender As Object, e As EventArgs) Handles Me.Leave
        Me.Dispose()
    End Sub
    Private Sub frm_Canc_OK_Enviado_CM_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPJ_SP_CANC_OK_ENVIADO_CM"
