...
Public Class frm_rpt_Canc_Rector_Mensal

    Private Sub frm_rpt_Canc_Rector_Mensal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub PopulaRelatorio()
        Try
            ...
            If cboOrigem.SelectedValue = 0 Then
                params.Add(New ReportParameter("prm1", "Relatório Operacional Mensal RECTOR - PF"))
            Else
                params.Add(New ReportParameter("prm1", "Relatório Operacional Mensal RECTOR - PJ"))
            End If
    ...
    Private Function GetDataSourceRelatorio() As DataTable
        Try
            ...
            If Not strDataIni = Nothing AndAlso Not strDataFim = Nothing Then
                ...
                Else
                    Return cls.Return_DataTable("EXEC FRPJ_SP_REPORT_OPERACIONAL_MENSAL_PJ " & strFiltros)
                End If
