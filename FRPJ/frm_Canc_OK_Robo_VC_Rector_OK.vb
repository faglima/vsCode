...
Public Class frm_Canc_OK_Robo_VC_Rector_OK
    Dim myDataSet As DataSet
    Private Sub frm_Canc_OK_Robo_VC_Rector_OK_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPJ_SP_CANC_OK_VC_RECTOR_OK"
