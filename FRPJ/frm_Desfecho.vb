...
Public Class frm_Desfecho
    Dim myDataSet As DataSet
    Private intProdutoGrupo As Integer
    Private intLocalCanc As Integer

    Private Sub frm_Desfecho_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Me.Dispose()
        Me.Close()
    End Sub

    Private Sub frm_Desfecho_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPJ_SP_DESFECHO @CodId_Prod_Grupo=" & intProdutoGrupo
            ...
            strSqlCbo = "EXEC FRPJ_SP_TIPO_RETENCAO_CBO"
            clsU.GetCboItems_DataGrid(strSqlCbo, cboTipoRet, "Tipo_Retencao", "Tipo Retenção")
            cboTipoRet.DisplayStyle = DataGridViewComboBoxDisplayStyle.Nothing

            DataGridView1.Columns.Remove("Motivo")
            strSqlCbo = "EXEC FRPJ_SP_CANC_MOTIVOS_CBO"
            clsU.GetCboItems_DataGrid(strSqlCbo, cboMotivo, "Motivo", "Motivo")
            ...
            strSqlCbo = "EXEC FRPJ_SP_CANC_CODIGOS_CBO " & intLocalCanc
            ...
            strSqlCbo = "EXEC FRPJ_SP_CANC_TIPO_CBO"
            clsU.GetCboItems_DataGrid(strSqlCbo, cboTipo, "Tipo_Devolucao", "Tipo_Devolucao")
