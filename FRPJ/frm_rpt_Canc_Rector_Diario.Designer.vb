...
Partial Class frm_rpt_Canc_Rector_Diario
    ...
    Private Sub InitializeComponent()
        ...
        Me.FRPJ_SP_REPORT_OPERACIONAL_DIARIO_PFBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.FRPJ_SP_REPORT_OPERACIONAL_DIARIO_PFTableAdapter = New FRPJ.DS_rptOperacionalTableAdapters.FRPJ_SP_REPORT_OPERACIONAL_DIARIO_PFTableAdapter()
        Me.Panel1.SuspendLayout()
        CType(Me.DS_rptOperacional, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.FRPJ_SP_REPORT_OPERACIONAL_DIARIO_PFBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'ReportViewer1
        '
        Me.ReportViewer1.Dock = System.Windows.Forms.DockStyle.Fill
        ReportDataSource1.Name = "DS_Canc_Rector_Diario"
        ReportDataSource1.Value = Me.FRPJ_SP_REPORT_OPERACIONAL_DIARIO_PFBindingSource
        Me.ReportViewer1.LocalReport.DataSources.Add(ReportDataSource1)
        Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "FRPJ.rpt_Canc_Rector_Diario.rdlc"
        ...
        '
        'FRPJ_SP_REPORT_OPERACIONAL_DIARIO_PFBindingSource
        '
        Me.FRPJ_SP_REPORT_OPERACIONAL_DIARIO_PFBindingSource.DataMember = "FRPJ_SP_REPORT_OPERACIONAL_DIARIO_PF"
        Me.FRPJ_SP_REPORT_OPERACIONAL_DIARIO_PFBindingSource.DataSource = Me.DS_rptOperacional
        '
        'FRPJ_SP_REPORT_OPERACIONAL_DIARIO_PFTableAdapter
        '
        Me.FRPJ_SP_REPORT_OPERACIONAL_DIARIO_PFTableAdapter.ClearBeforeFill = True
        '
        'frm_rpt_Canc_Rector_Diario
        '
        ...
        Me.Name = "frm_rpt_Canc_Rector_Diario"
        ...
        CType(Me.FRPJ_SP_REPORT_OPERACIONAL_DIARIO_PFBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents FRPJ_SP_REPORT_OPERACIONAL_DIARIO_PFBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents DS_rptOperacional As FRPJ.DS_rptOperacional
    Friend WithEvents FRPJ_SP_REPORT_OPERACIONAL_DIARIO_PFTableAdapter As FRPJ.DS_rptOperacionalTableAdapters.FRPJ_SP_REPORT_OPERACIONAL_DIARIO_PFTableAdapter
End Class
