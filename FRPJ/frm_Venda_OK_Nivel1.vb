...
Public Class frm_Venda_OK_Nivel1
    Dim myDataSet As DataSet
    Private Sub frm_Venda_OK_Nivel1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPF_SP_EMISSAO_OK_NIVEL1"
