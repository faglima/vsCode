...
Public Class frm_EndossoCC_NOK
    Dim myDataSet As DataSet
    Dim strParam
    Private Sub frm_EndossoCC_NOK_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub tsbtn_Select_Click(sender As Object, e As EventArgs) Handles tsbtn_Select.Click
        Try
            ...
            If Me.DataGridView1.RowCount > 0 Then
                ...
                lngRec = cls.Exec_Command_NQ("EXEC FRPF_SP_UPDATE_ENDOSSO_CC_NOK_SELECT " & strParam, 2)

                If lngRec > 0 Then
                    fLoadForm(strParam)
                Else
                    MessageBox.Show("Nenhum registro afetado!", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Error)
                End If
    ...
    Private Sub tsbtn_Unselect_Click(sender As Object, e As EventArgs) Handles tsbtn_Unselect.Click
        Try
            ...
            If Me.DataGridView1.RowCount > 0 Then
                ...
                lngRec = cls.Exec_Command_NQ("EXEC FRPF_SP_UPDATE_ENDOSSO_CC_NOK_UNSELECT " & strParam, 2)
    ...
    Private Sub tsbtn_Reproc_Click(sender As Object, e As EventArgs) Handles tsbtn_Reproc.Click
        Try
            ...
            lngRec = CLng(cls.Exec_Command_Scalar("EXEC FRPF_SP_ENDOSSO_CC_CHECK_ENVIAR_VC " & strParam, 2))

            If lngRec > 0 Then

                lngRec = 0
                lngRec = cls.Exec_Command_NQ("EXEC FRPF_SP_ENDOSSO_CC_UPDATE_NOK_REPROCESSAR_VC " & strParam, 2)
    ...
    Private Sub tsbtn_Nivel2_Click(sender As Object, e As EventArgs) Handles tsbtn_Nivel2.Click
        Try
            ...
            If lngRec > 0 Then
                fSalvar()
                lngRec = 0
                lngRec = cls.Exec_Command_NQ("EXEC FRPF_SP_ENDOSSO_CC_UPDATE_NOK_NIVEL2_VC @Login='" & Environment.UserName & "', " & strParam, 2)
    ...
    Private Sub fSalvar()
        Try
            ...
            strSql = "EXEC FRPF_SP_ENDOSSO_CC_NOK " & strParam
        ...
        Try
            ...
            ElseIf TypeOf senderGrid.Columns(e.ColumnIndex) Is DataGridViewButtonColumn AndAlso
               e.RowIndex >= 0 Then
                ...
                frm_Endosso_NOK_Baixar.Tag = DataGridView1.Item("CodId", e.RowIndex).Value & ";" & DataGridView1.Item("Origem", e.RowIndex).Value & ";3"
    ...
    Public Sub fLoadCboMotivo()
        Try
            ...
            dtr = cls.Return_DataReader("EXEC FRPF_SP_ENDOSSO_CC_NOK_MOTIVO_CBO", 2)
            With dtr

                If .HasRows Then
                    Do While .Read()
                        lstItems.Add(.Item("CCred_TFC_Proc_NOK_Motivo").ToString())
                    Loop
