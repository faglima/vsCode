...
Public Class frm_rpt_Sla_Emissao
    ...
    Private Sub PopulaRelatorio()
        Try
            ...
            Dim rptDS As New ReportDataSource("DsEmissao", dsTeste)
        ...
        Try
           ...
           strFiltros = cboMesrefIni.Text
            ...
            If Not strFiltros = Nothing Then
                Return cls.Return_DataTable("EXEC FRPJ_SP_RPT_SLA_Emissao " & strFiltros)
            Else
