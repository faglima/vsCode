...
Public Class frm_Clientes_Seg
    Dim myDataSet As DataSet
    Private Sub frm_Clientes_Seg_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPJ_SP_CLIENTES_SEGMENTO"
