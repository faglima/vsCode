...
Public Class frm_Endosso_NOK_Nivel2
    Dim myDataSet As DataSet
    Private Sub frm_Endosso_NOK_Nivel2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            DataGridView1.Columns("Premio_Antigo").DefaultCellStyle.Format = "n2"
            DataGridView1.Columns("ImpSegurada_Antigo").DefaultCellStyle.Format = "n2"
    ...
    Public Sub fLoadForm()
        ...
        Try
            ...
            strSql = "EXEC FRPF_SP_ENDOSSO_NOK_NIVEL2"
        ...
        Try
            ...
            If TypeOf senderGrid.Columns(e.ColumnIndex) Is DataGridViewButtonColumn AndAlso
               e.RowIndex >= 0 Then
                ...
                frm_Endosso_NOK_Nivel2_Baixar.Tag = DataGridView1.Item(2, e.RowIndex).Value & ";" & DataGridView1.Item(1, e.RowIndex).Value
                frm_Endosso_NOK_Nivel2_Baixar.Text = "Baixar Ligação Protocolo " & DataGridView1.Item(2, e.RowIndex).Value & " - Origem: " & DataGridView1.Item(1, e.RowIndex).Value
                frm_Endosso_NOK_Nivel2_Baixar.ShowDialog()
