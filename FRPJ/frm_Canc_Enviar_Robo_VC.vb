...
Public Class frm_Canc_Enviar_Robo_VC
    ...
    Private Sub frm_Canc_Enviar_Robo_VC_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPJ_SP_CANC_ENVIAR_ROBO_VC"
    ...
    Private Sub tsbtn_EnviarRobo_Click(sender As Object, e As EventArgs) Handles tsbtn_EnviarRobo.Click
        ...
        Try
            ...
            If Me.DataGridView1.RowCount > 0 Then
                ...
                lngReg = cls.Exec_Command_NQ("EXEC FRPJ_SP_CANC_UPDATE_ENVIAR_ROBO @Login='" & Environment.UserName & "', @LocalCanc=2,@Lotes=0,@TotalRegistros=0")
                ...
                Else
                    MessageBox.Show("0 Ligações enviadas para robô de cancelamento!", "Enviar para robô", MessageBoxButtons.OK, MessageBoxIcon.Information)
                End If
            Else
    ...
    Private Sub tsbtn_EnviarRobo2_Click(sender As Object, e As EventArgs) Handles tsbtn_EnviarRobo2.Click
        ...
        Try
            ...
            If Me.DataGridView1.RowCount > 0 Then
                ...
                lngReg = cls.Exec_Command_NQ("EXEC FRPJ_SP_CANC_UPDATE_ENVIAR_ROBO_VC_SELECT @Login='" & Environment.UserName & "'")

                If (lngReg) > 0 Then
                    MessageBox.Show(lngReg & " Ligações enviadas para cancelamento com sucesso, favor acionar o robô de cancelamento!", "Enviar para robô", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    frm_Canc_Enviar_Robo_VC_Load(sender, New EventArgs)
                Else
                    MessageBox.Show("0 Ligações enviadas para robô de cancelamento!", "Enviar para robô", MessageBoxButtons.OK, MessageBoxIcon.Information)
                End If
