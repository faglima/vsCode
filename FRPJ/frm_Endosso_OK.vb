...
Public Class frm_Endosso_OK
    Dim myDataSet As DataSet
    Private Sub frm_Endosso_OK_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            strSql = "EXEC FRPF_SP_ENDOSSO_OK @DataIni=" & strDataIni & ",@DataFim=" & strDataFim
    ...
    Private Sub btnFiltrar_Click(sender As Object, e As EventArgs) Handles btnFiltrar.Click
        Try
            ...
            strSql = "EXEC FRPF_SP_ENDOSSO_OK @DataIni=" & strDtIni & ",@DataFim=" & strDtFim & ",@Cpf=" & strCpf
            myDataSet = cls.Return_DataSet(strSql, 2)
    ...
    Private Sub btnLimpar_Click(sender As Object, e As EventArgs) Handles btnLimpar.Click
        Try
            ...
            strSql = "EXEC FRPF_SP_ENDOSSO_OK @DataIni=" & strDtIni & ",@DataFim=" & strDtFim
            myDataSet = cls.Return_DataSet(strSql, 2)
