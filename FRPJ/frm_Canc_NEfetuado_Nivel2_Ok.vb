...
Public Class frm_Canc_NEfetuado_Nivel2_Ok
    Dim myDataSet As DataSet
    Dim strEps As String = "0"

    Private Sub frm_Canc_NEfetuado_Nivel2_Ok_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Public Sub fLoadForm()
        Try
            ...
            strSql = "EXEC FRPJ_SP_NIVEL2_CANC_N_EFETUADO_OK @EPS=" & strEps
