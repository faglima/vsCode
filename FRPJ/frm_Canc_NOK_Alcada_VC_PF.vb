...
Public Class frm_Canc_NOK_Alcada_VC_PF
    Dim myDataSet As DataSet
    Private Sub frm_Canc_NOK_Alcada_VC_PF_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub tsbtn_Select_Click(sender As Object, e As EventArgs) Handles tsbtn_Select.Click
        Try
            ...
            If Me.DataGridView1.RowCount > 0 Then
                ...
                lngRec = cls.Exec_Command_NQ("EXEC FRPF_SP_CANC_UPDATE_NOK_TRUE_ALCADA_VC", 2)
    ...
    Private Sub tsbtn_Unselect_Click(sender As Object, e As EventArgs) Handles tsbtn_Unselect.Click
        Try
            ...
            If Me.DataGridView1.RowCount > 0 Then
                ...
                lngRec = cls.Exec_Command_NQ("EXEC FRPF_SP_CANC_UPDATE_NOK_FALSE_ALCADA_VC", 2)
    ...
    Private Sub tsbtn_Reproc_Click(sender As Object, e As EventArgs) Handles tsbtn_Reproc.Click
        Try
            ...
            lngRec = CLng(cls.Exec_Command_Scalar("EXEC FRPF_SP_CHECK_REPROC_ALCADA_VC", 2))

            If lngRec > 0 Then

                lngRec = 0
                lngRec = cls.Exec_Command_NQ("EXEC FRPF_SP_CANC_UPDATE_NOK_REPROC_ALCADA_VC", 2)
    ...
    Private Sub fSalvar()
        Try
            ...
            strSql = "EXEC FRPF_SP_CANC_NOK_ALCADA_VC"
    ...
    Private Sub fLoadForm()
        Try
            ...
            strSqlCbo = "EXEC FRPF_SP_CANC_CODIGOS_CBO 2"
