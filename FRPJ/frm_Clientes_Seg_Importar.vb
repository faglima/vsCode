...
Public Class frm_Clientes_Seg_Importar
    ...
    Private Sub btnImp_Click(sender As System.Object, e As System.EventArgs) Handles btnImp.Click
        ...
        Try
            ...
            strSqlTable = cls.Exec_Command_Scalar("select ValorParametro from tsys_Parametro where NomeParametro='CliSeg_SqlTable'")
            strFMTPath = cls.Exec_Command_Scalar("select ValorParametro from tsys_Parametro where NomeParametro='CliSeg_FMT'")
            ...
            lngRecords = ExecBulkFmt(strSqlTable, strFileD, 2, "", strFMTPath)

            MessageBox.Show("Registros carregados e processados com sucesso!", "Importar e Processar", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Function ExecBulkFmt(ByVal strSqlTable As String, ByVal strFileD As String, ByVal strFirstRow As String, ByVal strFieldTerminator As String, ByVal strFMTPath As String) As Integer
        ...
        Try
            ...
            'Processamento
            cls.Exec_Command_NQ("EXEC FRPJ_SP_INSERT_CLIENTES_SEGMENTO")
